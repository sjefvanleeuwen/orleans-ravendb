...
{
    /// <summary>
    /// Storage options for writing grain state data to RavenDB in JSON format.
    ...
    public class RavenDBStorageOptions
    {
        ...
        /// TODO: What is the equivalent in RavenDB
        /// </summary>
    ...
    /// </summary>
    public class RavenDBStorageOptionsValidator : IConfigurationValidator
    {
        ...
        public RavenDBStorageOptionsValidator(RavenDBStorageOptions options, string name)
        {
