...
using Orleans.Persistence.RavenDB.Provider;
...
namespace Orleans.Storage
{
    ...
    public class RavenDBGrainStorage : IGrainStorage, ILifecycleParticipant<ISiloLifecycle>
    {
        ...
        {
            lifecycle.Subscribe(OptionFormattingUtilities.Name<RavenDBGrainStorage>(this.name), this.options.InitStage, Init);
        }
